...
export default function FloatingButtons() {
  ...
  return (
    <>
      ...
      <a href="https://wa.me/1234567890" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 w-14 h-14 bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg shadow-green-900/30 z-40 ring-1 ring-white/10">💬</a>
